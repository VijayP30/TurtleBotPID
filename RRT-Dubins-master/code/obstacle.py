...
class Obstacle:
    ...
    def __init__(self, map_dimensions, nb_pts, points):
            ...
            # angles = sorted((np.pi/2 for _ in range(nb_pts)))
            # self.points = \
            #     np.array([self.center +\
            #               np.array([size*np.cos(angle), size*np.sin(angle)])\
            #               for angle in angles])
            #self.points = ((40., 90.), (40., 100.), (60., 100.), (60., 90.))
            self.points = points
            ...
            # coords = ((50., 50.), (50., 55.), (55., 55.), (55., 50.))
