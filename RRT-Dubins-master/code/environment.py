...
class StaticEnvironment:
    ...
    def __init__(self, dimensions):
        ...
        # self.obstacles = [Obstacle(dimensions, 5)\
        #                   for _ in range(nb_obstacles)]
        self.obstacles = [Obstacle(dimensions,5,((40., 90.), (40., 100.), (60., 100.), (60., 90.))),
                            Obstacle(dimensions,5,((0., 10.), (0., 100.), (10., 100.), (10., 10.))),
                            Obstacle(dimensions,5,((85., 0.), (85., 75.), (100., 75.), (100., 0.))),
                            Obstacle(dimensions,5,((70., 0.), (70., 7.5), (80., 7.5), (80., 0.)))]
        for i in range(20):
            centerX = np.random.rand()*100
            centerY = np.random.rand()*100
            self.obstacles.append(Obstacle(dimensions,5,((centerX-3, centerY-3), (centerX-3, centerY+3), (centerX+3, centerY+3), (centerX+3, centerY-3))))
    ...
    def is_free(self, x, y, time=0):
        ...
        or y < 0 or y > self.dimensions[1]:
            return False
        for obstacle in self.close_obstacles(x, y, nb_obstacles=24):
